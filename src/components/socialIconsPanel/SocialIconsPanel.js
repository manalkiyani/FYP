...
const SocialIconsPanel = ({show,closePanel,socialIcons,handleSocialIcons}) => {
    const [icons,setIcons] = useState(
        [
        {icon:'Facebook',url:'https://res.cloudinary.com/djlewzcd5/image/upload/v1670229851/facebook_nunoeq.png',link:''},
        ...
        {icon:'LinkedIn',url:'https://res.cloudinary.com/djlewzcd5/image/upload/v1670230193/linkedin_s4wzkh.png',link:''},
        {icon:'Whatsapp',url:'https://res.cloudinary.com/djlewzcd5/image/upload/v1670230148/whatsapp_lg8yre.png',link:''},
        {icon:'Gmail',url:'https://res.cloudinary.com/djlewzcd5/image/upload/v1670249983/-11597283055r5ynokf2kb_ym9yeb.png',link:''},
        {icon:'SnapChat',url:'https://res.cloudinary.com/djlewzcd5/image/upload/v1670249895/snapchat-logo-icon-png-snapchat-logo-circle-11562922134qgu9m89jgh_jrxlj2.png',link:''},
        {icon:'Youtube',url:'https://res.cloudinary.com/djlewzcd5/image/upload/v1670249662/free-youtube-logo-icon-2431-thumb_wssgc7.png',link:''},
        {icon:'Pinterest',url:'https://res.cloudinary.com/djlewzcd5/image/upload/v1670232984/pinterest_g6aazw.png',link:''}
        ]
    ...
    const filteredIcons = [];
    const addIcon = "https://res.cloudinary.com/djlewzcd5/image/upload/v1670250225/plus_2_qak15o.png";
                           ...
                           filteredIcons.push(icon)
                            ...
                            <div   key={icon} className={classes.group}>
                                ...
                                <TextField 
                                    ...
                                    variant="outlined" 
                                    size="small"/>
                                <img className={classes.item} alt="delete" src={del} onClick={()=>deleteIcon(icon)}/>
                             </div>
                            )
                           
                            })}
                            <button className={classes.btn} onClick={sendUpdatedSocialIcons} >Link</button>
                    </div>
