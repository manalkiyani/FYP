  ...
  render() {
    return (
      ...
      >
        ...
        <SimpleGrid cols={this.props.Data.layout} spacing={20}>
              ...
              >
                ...
                >
                  ...
                  <ContentEditable
                    ...
                    disabled={false}
                    onClick={() =>this.props. onClick(this.props.id, "p", index, "features1")}
                    ...
                    style={{
                      ...
                      fontWeight:
                        this.props.Data.data[index].p.bold === true ? "bold" : "normal",
                      textDecoration:
