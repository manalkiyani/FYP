...
function Plan() {
  ...
  return (
    <>
          ...
          <div className="column">
            <ul className="price">
              <li  className="header">
                ...
                <div value='starter' onClick={()=>{handleButton('starter')}} className="button_cont" align="center">
          ...
          <div className="column">
            <ul className="price">
              <li className="header">
                ...
                <p>per user per month</p>
                <div value='Professional' onClick={()=>{handleButton('professional')}}  className="button_color" align="center">
                  <a className="btn" target="_blank" rel="nofollow noopener" >
                    Go Professional
                  </a>
                </div>
          ...
          <div className="column">
            <ul className="price">
              <li className="header">
                ...
                <p>per user per month</p>
                <div value='Organization' onClick={()=>{handleButton('organization')}}  className="button_cont" align="center">
                  <a className="btn" target="_blank" rel="nofollow noopener">
                    Go Organization
                  </a>
                </div>
      ...
      {open && <PlanPaymentForm setOpen={setOpen} activePlan={activePlan} amount={amount}></PlanPaymentForm>}
    </div>
    </>
